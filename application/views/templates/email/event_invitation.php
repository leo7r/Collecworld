...
<title><?php echo $title_email ?></title>
										...
										<tr>
											...
											<td>
												<table>
													<tr>
														<td>
												<p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin:3px; line-height: 10px;"><b><?php echo $user; ?></b></p>														
														</td>													
													</tr>
													<tr>
														<td>
												<p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #999; margin:3px; line-height: 10px;"> <?php echo $name; ?>                                                      </p>
                                    	...
                                    	<tr>
                                            <td class="blog_description" valign="top" align="left" style="width:500px;">
												...
												<tr>
                                                    	<td valign="top">
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<b><?php echo $namet; ?>:</b> <?php echo $name_event; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td valign="top">
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<b><?php echo $categoryt; ?>:</b> <?php echo $category; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td valign="top">
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<b><?php echo $countryt; ?>:</b> <?php echo $country; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                	<tr>
                                                    	<td valign="top">
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<b><?php echo $placet; ?>:</b> <?php echo $place_event; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
													<tr>
                                                    	<td valign="top">
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<b><?php echo $datet; ?>:</b> <?php echo $date_event; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
													<tr>
                                                    	<td valign="top">
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<b><?php echo $descriptiont; ?>:</b> <?php echo $description_event; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            	...
                                            	<table cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td bgcolor="#3396d8" height="30" width="110" align="center" class="button" style="font-family: 'Raleway', font-size: 12px; color: #ffffff; font-size: 13px; text-align: center; font-weight: normal; border-radius: 3px;">
															<a class="nodecoration" href="http://collecworld.com/index.php/event/<?php echo $id_event; ?>" style="text-decoration: none; display: block; color: #ffffff; line-height: 30px;">
																<?php echo $view_more; ?>
															</a>
														</td>
                                                    </tr>
