...
<title>User added you to Collecworld</title>
                                                                ...
                                                                <tr>
                                                                    <td class="social_button" style="width: 24px;">
                                                                        <a href="#" class="nodecoration" style="text-decoration: none;">
                                                                            <img src="http://labs.am-themes.com/Flattr/imgs/fb.png" width="24" height="24" style="display: block;" border="0" alt="FB"  />
                                                                        </a>
                                                                    </td>
                                                                    ...
                                                                    <td class="social_button" style="width: 24px;">
                                                                        <a href="#" class="nodecoration" style="text-decoration: none;">
                                                                            <img src="http://labs.am-themes.com/Flattr/imgs/g+.png" width="24" height="24" style="display: block;" border="0" alt="G+"  />
                                                                        </a>
                                                                    </td>
                                                                    <td class="social_spacer" style="width: 6px;">
                                                                    </td>
                                                                    <td class="social_button" style="width: 24px;">
                                                                        <a href="#" class="nodecoration" style="text-decoration: none;">
                                                                            <img src="http://labs.am-themes.com/Flattr/imgs/tw.png" width="24" height="24" style="display: block;" border="0" alt="TW"  />
                                                                        </a>
                                                                    </td>
                                                                    <td class="social_spacer" style="width: 6px;">
                                                                    </td>
                    	...
                    	<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                            	<td class="content_row featured_image" align="left" style="width: 580px; color:#fff;">
									<h1>User added you to Collecworld!</h1>
                                </td>
                            </tr>
                        </table>
                    </td>
										...
										<tr>
											<td>
												<a href="#" style="text-decoration: none;" class="nodecoration">
													<img class="noresize" src="http://labs.am-themes.com/Flattr/imgs/team1.png" width="121" height="121" style="display: block; border-radius: 6px;" border="0" alt=""  />
												</a>
											</td>
											<td>
												<table>
													<tr>
														<td>
												<p class="blog_excerpt" style="font-family: "Raleway"; font-size: 14px; color: #394041; margin:3px; line-height: 10px;"><b>User</b> MyUser</p>
														
														</td>													
													</tr>
													<tr>
														<td>
												<p class="blog_excerpt" style="font-family: "Raleway"; font-size: 14px; color: #999; margin:3px; line-height: 10px;">About                                                       </p>
														
														</td>													
													</tr>
													<tr>
														<td>
												<p class="blog_excerpt" style="font-family: "Raleway"; font-size: 14px; color: #394041; margin:3px; line-height: 10px;">Country                                                         </p>
                    	...
                    	<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                            	<td class="content_row" style="width: 580px; color: #394041; font-size: 12px; text-align: center; font-family: "Raleway";">
                                	<a href="#" style="text-decoration: none; color: #394041;"><a href="#" style="text-decoration: none; color: #394041;">Please Unsubscribe me</a><br/>
                                   <br/>
This message is sent to you by Collecworld, Venezuela and delivered to<br/><br/> <a href="#" style="text-decoration: none; color: #394041;"><?php echo $email; ?></a>
                                </td>
                            </tr>
                            <tr>
                            	<td class="content_row" style="width: 580px;" height="20">
