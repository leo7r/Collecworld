...
<div id="content">
		...
		<div class="in">
			...
			<div id="toolbar-left">
				...
				<div class="item location">
					...
					&nbsp;<a href="<?php echo base_url(); ?>index.php/init">Home</a>&nbsp;&raquo;&nbsp;<a href="<?php echo base_url(); ?>index.php/help">Help Center</a>&nbsp;&raquo;&nbsp;<a href="">Tools</a>&nbsp;&raquo;
	...
	<div id="content-in">
		...
		<div id="account-title" >
			...
			<span style="text-indent:0; color:#000; cursor:pointer;" onclick="location.href='javascript:window.history.back();'">&laquo;<?php echo $this->lang->line('regresar'); ?></span><span style="float:right"><?php echo $this->lang->line('centro_ayuda'); ?> &raquo; <?php echo $this->lang->line('herramientas'); ?></span>
...
.content-in{
	...
	<div class="content-in" >
    	...
    	<div id="personal_listing">

            <h1><?php echo $this->lang->line('help_listados_personales_titulo'); ?></h1>

         <?php echo $this->lang->line('help_listados_personales_contenido'); ?>   

        </div>

        <div id="notes">

            <h1><?php echo $this->lang->line('help_notas_listados_titulo'); ?></h1>

            <?php echo $this->lang->line('help_notas_listados_contenido'); ?>

        </div>

        <div id="comparison">

            <h1> <?php echo $this->lang->line('help_comparacion_listados_titulo'); ?></h1>

           <?php echo $this->lang->line('help_comparacion_listados_contenido'); ?> 

        </div>

         <div id="export">

            <h1><?php echo $this->lang->line('help_exportar_titulo'); ?></h1>

          <?php echo $this->lang->line('help_exportar_contenido'); ?>  
