	...
	<div id="toolbar">
		...
		<div id="content-in">
			<div id="welcome-page" class="box1">
				<div id="welcome-img" >
					<img src="<?php echo base_url(); ?>img/cross.jpg" width="150" />
				</div>
				<div id="welcome-title">
					<?php echo $this->lang->line('usuario_no_activado'); ?>
				</div>
				<div id="welcome-info">
					<p><?php echo $this->lang->line('error_en_la_activacion_usuario'); ?>.</p>
					<p><?php echo $this->lang->line('por_favor_intente_activar_otra_vez'); ?> <a href="javascript:modalFeedback()"><?php echo $this->lang->line('contactanos'); ?></a>.</p>
				</div>
			</div>
		</div>
</div>
