...
<script>
	$(document).ready(function(){
		var showPc =  parseInt($(document).getUrlParam("showCoin"));
...
<div id="content">
		...
		<div class="in">
			<div id="toolbar-left">
				<div class="item location">
					...
					<a href="<?php echo base_url().'index.php/explore/coin'; ?>"><?php echo $this->lang->line('header_explorar_monedas'); ?></a>&nbsp;&raquo;&nbsp;  
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog; ?>" title="<?php echo ucfirst($catalog); ?>"><?php echo trimm(ucfirst($catalog),17); ?></a>&nbsp;&raquo;&nbsp; 
					<a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country; ?>" title="<?php echo $country_name; ?>"><?php echo trimm($country_name,17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titlec; ?>" title="<?php echo ucfirst($title_name); ?>"><?php echo trimm(ucfirst($title_name),17);  ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titlec.'&subtitle='.$subtitle; ?>" title="<?php echo ucfirst($subtitle_name); ?>"><?php echo trimm(ucfirst($subtitle_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titlec.'&subtitle='.$subtitle.'&denomination='.$denomination; ?>" title="<?php echo ucfirst($denomination_name); ?>"><?php echo trimm(ucfirst($denomination_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titlec.'&subtitle='.$subtitle.'&denomination='.$denomination.'&value='.$value; ?>" title="<?php echo ucfirst($value_name); ?>"><?php echo trimm(ucfirst($value_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titlec.'&subtitle='.$subtitle.'&denomination='.$denomination.'&value='.$value.'&composition='.$composition; ?>" title="<?php echo ucfirst($composition_name); ?>"><?php echo trimm(ucfirst($composition_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titlec.'&subtitle='.$subtitle.'&denomination='.$denomination.'&value='.$value.'&composition='.$composition.'&year='.$year; ?>"><?php if ($year=="allyears"){echo $this->lang->line('explore_phonecards_todos_ano');}else if($year=="unknown"){echo $this->lang->line('desconocido');}else{ echo $year;} ?></a>&nbsp;&raquo;&nbsp; 
				</div>
			</div>
	...
	<?php
		$url = base_url().'index.php/explore/coin/'.$catalog.'/'.$country.'/'.$titlec.'/'.$subtitle.'/'.$denomination.'/'.$value.'/'.$composition.'/'.$year;
		 
		$url = $url.'/1';
		//echo $url;
	?>
	<div id="content-in">
		<input type="hidden" id="explore_url" value="<?php echo $url.( $order ? '/'.$order : "" ); ?>" />
      ...
      <table width="100%">
            	...
            	<td>
                	<div id="explore_sort" class="box1">
                        <table width="100%">
                            <tr>
                                <td>
                                    <?php echo $this->lang->line('ordenar_monedas_por'); ?>:&nbsp;
		...
		<?php
			include 'show_coins_content.php';
		?>
	</div>
</div>