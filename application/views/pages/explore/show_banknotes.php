...
<div id="content">
		...
		<div class="in">
			<div id="toolbar-left">
				<div class="item location">
					...
					<a href="<?php echo base_url().'index.php/explore/banknote'; ?>"><?php echo $this->lang->line('header_explorar_billetes'); ?></a>&nbsp;&raquo;&nbsp;  
                    <a href="<?php echo base_url().'index.php/explore/banknote/?catalog='.$catalog; ?>" title="<?php echo ucfirst($catalog); ?>"><?php echo trimm(ucfirst($catalog),17); ?></a>&nbsp;&raquo;&nbsp; 
					<a href="<?php echo base_url().'index.php/explore/banknote/?catalog='.$catalog.'&country='.$country; ?>" title="<?php echo $country_name; ?>"><?php echo trimm($country_name,17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/banknote/?catalog='.$catalog.'&country='.$country.'&title='.$titleb; ?>" title="<?php echo ucfirst($title_name); ?>"><?php echo trimm(ucfirst($title_name),17);  ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/banknote/?catalog='.$catalog.'&country='.$country.'&title='.$titleb.'&subtitle='.$subtitle; ?>" title="<?php echo ucfirst($subtitle_name); ?>"><?php echo trimm(ucfirst($subtitle_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/banknote/?catalog='.$catalog.'&country='.$country.'&title='.$titleb.'&subtitle='.$subtitle.'&denomination='.$denomination; ?>" title="<?php echo ucfirst($denomination_name); ?>"><?php echo trimm(ucfirst($denomination_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/banknote/?catalog='.$catalog.'&country='.$country.'&title='.$titleb.'&subtitle='.$subtitle.'&denomination='.$denomination.'&value='.$value; ?>" title="<?php echo ucfirst($value_name); ?>"><?php echo trimm(ucfirst($value_name),17); ?></a>&nbsp;&raquo;&nbsp; 
                    <a href="<?php echo base_url().'index.php/explore/coin/?catalog='.$catalog.'&country='.$country.'&title='.$titleb.'&subtitle='.$subtitle.'&denomination='.$denomination.'&value='.$value.'&year='.$year; ?>"><?php if ($year=="allyears"){echo $this->lang->line('explore_phonecards_todos_ano');}else if($year=="unknown"){echo $this->lang->line('desconocido');}else{ echo $year;} ?></a>&nbsp;&raquo;&nbsp; 
				</div>
			</div>
	...
	<div id="content-in">
      ...
      <table width="100%">
            	...
            	<td>
                	<div id="explore_sort" class="box1">
                        <table width="100%">
                            <tr>
                                <td>
                                    <?php echo $this->lang->line('ordenar_billetes_por'); ?>:&nbsp;
                                ...
                                <td>
                                    ...
                                    <?php echo $this->lang->line('no_mostrar_variantes'); echo $no_variations; ?>
                                </td>
                            </tr>
                        </table>			
                    </div>
		...
		<?php
			include 'show_banknotes_content.php';
		?>
	</div>
</div>