		...
		<div id="toolbar">
			...
			<div class="in">
				...
				<div id="toolbar-left">
					...
					<div class="item location">
						...
						&nbsp;<a href="<?php echo base_url().'index.php/init'; ?>"><?php echo $this->lang->line('inicio'); ?></a>&nbsp;&raquo;&nbsp;<a href=""><?php echo $this->lang->line('cargar'); ?></a>&nbsp;&raquo;
			...
			<div id="content-in">
				...
				<div class="title42" style="text-align:center;">
                   ...
                   <?php echo $this->lang->line('upload_tarjetas_mensaje_catalogo_cerrado'); ?> <a href="mailto:support@collecworld.com" >support@collecworld.com</a>
