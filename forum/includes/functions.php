...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
	...
	$template->assign_vars(array(
		'SITENAME'						=> 'Collecworld Forum',
		'SITE_DESCRIPTION'				=> 'Forum for collectors on Collecworld',
		...
		'S_FORUM_ID'			=> $forum_id,
		'S_TOPIC_ID'			=> $topic_id,
		'S_SESSION_LANG_ENABLE'	=> (($config['lang_select_enable'] || $config['lang_click_enable']) && !in_array($page_name, $pages_array) && $value_found != true) ? true : false,
