...
/** 
*
* acp_ban.php [Argentinian Spanish]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_EXPLAIN'			=> 'Acá podes controlar las exclusiones de usuarios por nombre, IP o dirección de email. Este método impide a un usuario acceder a cualquier parte del Sitio. Si queres podes dar una razón breve (255 caracteres) para la exclusión. Se mostrará en el registro del admin. También podes especificar la duración de la exclusión. Si queres que la exclusión termine en una fecha específica en lugar de después de un periodo de tiempo, selecciona <u>Hasta</u> en la duración de la exclusión e ingresa la fecha con el formato aaaa-mm-dd.',

	'BAN_EXCLUDE'				=> 'Quitar exclusión',
	'BAN_LENGTH'				=> 'Duración de la exclusión',
	'BAN_REASON'				=> 'Razón de la exclusión',
	'BAN_GIVE_REASON'			=> 'Explicación de la razón de exclusión',
	...
	'EMAIL_BAN_EXPLAIN'			=> 'Para especificar más de una dirección de email ingresa cada una en una nueva línea. Para direcciones parciales usa * como comodín, p.ej. <samp>*@hotmail.com</samp>, <samp>*@*.domain.tld</samp>, etc.',
	'EMAIL_NO_BANNED'			=> 'No hay direcciones de email excluidas',
	'EMAIL_UNBAN'				=> 'Levantar exclusión de email',
	'EMAIL_UNBAN_EXPLAIN'		=> 'Podes quitar la exclusión a múltiples direcciones de email al mismo tiempo usando la combinación apropiada de ratón y teclado para tu navegador (p.ej. Ctrl+Clic). Las direcciones de email <em>excluidas</em> están en negrita.',
	...
	'IP_BAN_EXPLAIN'			=> 'Para especificar más de una IP ingresa cada una en una nueva línea. Para especificar un rango de direcciones IP separa el inicio y el final con un guión (-), para especificar un comodín usa *',
	'IP_HOSTNAME'				=> 'Direcciones IP o hostnames',
	'IP_NO_BANNED'				=> 'No hay direcciones IP excluidas',
	'IP_UNBAN'					=> 'Levantar exclusión de IPs',
	'IP_UNBAN_EXPLAIN'			=> 'Podes quitar la exclusión a múltiples direcciones IP al mismo tiempo usando la combinación apropiada de ratón y teclado para tu navegador (p.ej. Ctrl+Clic). Las direcciones IP <em>excluidas</em> están en negrita.',
