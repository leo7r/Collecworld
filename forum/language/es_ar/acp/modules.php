...
/** 
*
* acp_modules.php [Argentinian Spanish]
*
* @package language
...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'		=> 'Acá podes manejar toda clase de módulos. Por favor observa que el Panel de Administración (ACP) tiene una estructura de menú de tres niveles (Categoría -> Subcategoría -> Módulo) por lo cual los otros tienen una estructura de menú de dos niveles (Categoría -> Módulo) la cual debe ser respetada. Por favor date cuenta que podes bloquearte a si mismo si deshabilita o borra el módulo de administración de módulos.',
	...
	'DELETE_MODULE_CONFIRM'				=> '¿Estás seguro de que queres borrar este módulo?',

	'EDIT_MODULE'						=> 'Editar módulo',
	'EDIT_MODULE_EXPLAIN'				=> 'Acá podes introducir parámetros específicos del módulo',
	...
	'MODULE_DISPLAYED_EXPLAIN'			=> 'Si no querés mostrar este módulo, pero querés usarlo, selecciona No.',
