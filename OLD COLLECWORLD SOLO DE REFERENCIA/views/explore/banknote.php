		...
		<div class="in">
			...
			<div id="toolbar-left">
				...
				<div class="item location">
					...
					&nbsp;<a href="<?php echo base_url(); ?>index.php/init"><?php echo $this->lang->line('inicio'); ?></a>&nbsp;&raquo;&nbsp;<a href="<?php echo base_url(); ?>index.php/explore/banknote"><?php echo $this->lang->line('header_explorar_billetes'); ?></a>&nbsp;&raquo;
                    ...
                    <td colspan="3">
                        ...
                        <div id="explore-catalog" >
                            ...
                            <table id="explore-catalog-table" cellspacing="10">
                                ...
                                <tr>
                                	<td id="circulationF" class="box1 selected" onClick="explore_catalog_banknote(this,0);">
    
                                        <div><?php echo $this->lang->line('circulacion_total'); ?></div>
    
                                    </td>
    
                                    <td id="circulationN" class="box1" onClick="explore_catalog_banknote(this,1);">
    
                                        <div><?php echo $this->lang->line('circulacion_normal'); ?></div>
    
                                    </td>
    
                                    <td id="circulationC" class="box1" onClick="explore_catalog_banknote(this,2);">
    
                                        <div><?php echo $this->lang->line('conmemorativas_numismaticas'); ?></div>
    
                                    </td>
    
                                    <td id="circulationO" class="box1" onClick="explore_catalog_banknote(this,3);" >
								...
								<ul id="explore-country-list">
									...
									<?php
										...
										for ( $i = 0 ; $i < count($countries) ; $i++ ){
											...
											<li id="cou-<?php echo $countries[$i]['abbreviation']; ?>" onClick="explore_country_banknote(this,'<?php echo $countries[$i]['abbreviation']; ?>');" ><?php echo $countries[$i]['name'].' ('.$countries[$i]['num'].')'; ?></li>
                    ...
                    <td>
                    	<div id="explore-go">
                            ...
                            <!-- Explore year -->
                                ...
                                <span class="google-button google-button-blue" onClick="send_explore_banknote();" >
