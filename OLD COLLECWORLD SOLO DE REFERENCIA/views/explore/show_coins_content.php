	...
	?>
		...
		<div class="explore-item" >			
			...
			<div class="explore-item-title" onClick="modalCoin(<?php echo $coins[$i]['id_coins']; ?>);">
				...
				<?php echo trimm($coins[$i]['value'],10).' '.trimm($coins[$i]['denomination'],40); ?>
			...
			<div onClick="modalCoin(<?php echo $coins[$i]['id_coins']; ?>);">
				...
				<table cellpadding="7"> 
                    ...
                    <tr>
						...
						<td><strong><?php echo $this->lang->line('aleacion'); ?>:</strong><td>

						<td>
						<?php
							if($coins[$i]['composition']){
								echo trimm($coins[$i]['composition'],17);
							}else{
                    ...
                    <tr>
						...
						<td>
						<?php
							if($coins[$i]['issued_on_gre']){
								echo trimm($coins[$i]['issued_on_gre'],17); 
							}else{
								echo $this->lang->line('desconocido');	
							}
						?>
