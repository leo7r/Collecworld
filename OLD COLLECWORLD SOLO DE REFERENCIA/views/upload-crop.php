	...
	function done2(){
		...
		*/
		...
		, function(){
			...
			location.href = '../upload/?cat=1&'+document.getElementById('onDone').value;
			//alert(div.innerHTML);
		});
...
if ( strcmp($anverse,"") != 0 and file_exists($path.'upload/img/'.$anverse) )
	$size0 = getimagesize($path.'upload/img/'.$anverse);
else
	$size0 = 0;

if ( strcmp($reverse,"") != 0 and file_exists($path.'upload/img/'.$reverse) )
	$size1 = getimagesize($path.'upload/img/'.$reverse);
else
	$size1 = 0;
...
<div id="crop_content">
	...
	<div id="crop_left">
		...
		<div class="crop_img">
			<div><img id="image" src="<?php if ( strcmp($anverse,"") != 0 ) echo base_url().'upload/img/'.$anverse; else echo ''; ?>" /></div>
		</div>
	</div>
	...
	<div id="crop_right">
		...
		<div class="crop_img">
			<div><img id="image_r" src="<?php if ( strcmp($reverse,"") != 0 ) echo base_url().'upload/img/'.$reverse; else echo ''; ?>" /></div>
		</div>
	</div>
</div>