...
<a id="modalP" style="display:none;" rel="leanModal" href="#modal-coins">a</a>
		...
		<div class="in">
			<div id="toolbar-left">
				<div class="item location">
					&nbsp;<a href="<?php echo base_url(); ?>index.php/init"><?php echo $this->lang->line('inicio'); ?></a>&nbsp;&raquo;&nbsp;<a href="<?php echo base_url(); ?>index.php/search/<?php echo str_replace(' ','+',$query); ?>"><?php echo $this->lang->line('busqueda'); ?> <b><?php echo $query; ?></b></a>&nbsp;&raquo;&nbsp;<a href=""><?php echo $this->lang->line('monedas'); ?></a>
				</div>
			</div>
