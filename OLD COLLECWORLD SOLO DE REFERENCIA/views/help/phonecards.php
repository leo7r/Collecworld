...
<div id="content">
		...
		<div class="in">
			...
			<div id="toolbar-left">
				...
				<div class="item location">
					...
					&nbsp;<a href="<?php echo base_url(); ?>index.php/init"><?php echo $this->lang->line('inicio'); ?></a>&nbsp;&raquo;&nbsp;<a href="<?php echo base_url(); ?>index.php/help"><?php echo $this->lang->line('centro_ayuda'); ?></a>&nbsp;&raquo;&nbsp;<a href=""><?php echo $this->lang->line('cargar_tarjeta_telefonica'); ?></a>&nbsp;&raquo;
	...
	<div id="content-in">
		...
		<div id="account-title" >
			...
			<span style="text-indent:0; color:#000; cursor:pointer;" onclick="location.href='javascript:window.history.back();'">&laquo;<?php echo $this->lang->line('regresar'); ?></span><span style="float:right"> <?php echo $this->lang->line('centro_ayuda'); ?>&raquo; <?php echo $this->lang->line('cargar_tarjeta_telefonica'); ?></span>
...
.content-in{
    ...
    <?php echo $this->lang->line('help_cargar_tarjeta_telefonica'); ?>	
