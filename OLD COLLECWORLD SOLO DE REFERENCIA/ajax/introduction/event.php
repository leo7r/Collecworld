...
<div id="show-intro">
	...
	<div id="show-feedback-info" style="text-align:left">
		<strong><?php echo $lang['lista_de_eventos']; ?></strong>
		<br>
        <?php echo $lang['aqui_encontraras_los_eventos_publicos']; ?>
	</div>
        	...
        	<div id="demo7" class="demo1" style="margin-left:-100px;">
                ...
                <div class="slides" style="padding-top:10px;">
                    <div>
                        <table width="600px">
                            <tr>
                                <td width="300px"><img src="<?php echo $path; ?>img/introduction/event1.png" class="intro-thumb" /></td>
                                <td width="300px" valign="top">
                                <p style="width:160px; font-size:14px; padding-left:8px;"><strong><?php echo $lang['1_lista_de_eventos']; ?></strong><br />
                                <br />
                                <?php echo $lang['los_eventos_apareceran']; ?>. </p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div>
                        <table width="600px">
                            <tr>
                                <td width="300px" height="180px"><img src="<?php echo $path; ?>img/introduction/event2.png" class="intro-thumb" /></td>
                                <td width="300px" valign="top">
                                <p style="width:160px; font-size:14px; padding-left:8px;"><strong><?php echo $lang['2_crear_evento']; ?></strong><br />
                                <br />
                                <?php echo $lang['introduccion_crear_evento']; ?>. </p>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <tr>
                	<td>
                        ...
                        <div id="feedback-content-bottom">
                            <span style="" class="google-button google-button-red" onClick="introViewed(4,'<?php echo $_SESSION['user']; ?>');"> <?php echo $lang['no_volver_a_mostrar']; ?></span>
                        </div>
                   	</td>
                </tr>
            </table>
