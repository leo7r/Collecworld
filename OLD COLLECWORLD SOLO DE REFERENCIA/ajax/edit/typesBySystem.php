...
<table id="variation1_table" style="margin:0;">
	...
	for ($i=0 ; $i < mysql_num_rows($scursor) ; $i++){
		...
		<tr <?php echo $i % 2 == 0 ? '':'class="odd"'; ?> >
			<td><input onchange="allowOne('variation1_list',this);" <?php if ( strval($syst) == strval($sdatos['id_phonecards_systems']) ) echo 'checked="checked"' ?> type="checkbox" value="<?php echo $sdatos['id_phonecards_systems']; ?>" name="sys_type<?php echo $i; ?>" /></td>
	...
	<input type="hidden" value="<?php echo $syst; ?>" id="var1" name="var1" />
