...
<script>
    ...
    function sendFb( user ){
        ...
        if ( text.length > 3 ){
            ...
            showGlobalInfo('<?php echo $lang['feedback_muy_corto']; ?>');
...
<div id="show-feedback">
	...
	<div id="show-feedback-info">
		...
		<?php echo $lang['no_aparece_forma_moneda']; ?>. <?php echo $lang['nota_recomendamos_cargar_foto']; ?>.
	...
	<div id="feedback-content">
		...
		<form id="feedback-form" action="<?php echo $path; ?>index.php/sendFeedback" method="post" enctype="multipart/form-data" >
            ...
            <input type="hidden" name="about" value="New Coin Form" />
        	...
        	<table>
                ...
                <tr>
                	...
                	<td><?php echo $lang['que_forma_moneda_falta']; ?></td>
