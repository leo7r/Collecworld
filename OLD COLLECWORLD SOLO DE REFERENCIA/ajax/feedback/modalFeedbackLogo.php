...
<?php echo $lang['no_aparece_logo']; ?>. <?php echo $lang['nota_recomendamos_cargar_foto']; ?>.
		<br>
	</div>
	<div id="feedback-content">
		<form id="feedback-form" action="<?php echo $path; ?>index.php/sendFeedback" method="post" enctype="multipart/form-data" >
            ...
            <input type="hidden" name="about" value="New Logo" />
        	<table>
            	<tr>
                ...
                <tr>
                	<td><?php echo $lang['que_logo_tienes']; ?></td>
                </tr>
                <tr>
                	<td>
