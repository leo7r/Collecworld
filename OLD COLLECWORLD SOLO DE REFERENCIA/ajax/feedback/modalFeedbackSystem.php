...
<div id="show-feedback">
	...
	<div id="show-feedback-info">
		...
		<?php echo $lang['no_aprece_sistema_reportar']; ?>. <?php echo $lang['nota_recomendamos_cargar_foto']; ?>.
	...
	<div id="feedback-content">
		...
		<form id="feedback-form" action="<?php echo $path; ?>index.php/sendFeedback" method="post" enctype="multipart/form-data" >
            ...
            <input type="hidden" name="about" value="New system" />
        	...
        	<table>
                ...
                <tr>
                	...
                	<td><?php echo $lang['pais_del_tipo_de_sistema']; ?></td>
                ...
                <tr>
                	...
                	<td><?php echo $lang['descripcion_tipo_de_sistema']; ?></td>
