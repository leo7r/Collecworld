...
<script>
    ...
    function sendFb( user ){
        ...
        if ( text.length > 3 && country != -1 && title != -1){
            ...
            $("#feedback-content-in").val($("#feedback-content-in").val()+" | country: "+country+" | title"+title);
            ...
            document.getElementById('feedback-form').submit();
             ...
             showGlobalInfo('<?php echo $lang['feedback_muy_corto_o_pais_titulo_no_seleccionado']; ?>');
...
<?php echo $lang['tu_correo_electronico']; ?></td>
                ...
                <tr>
                    ...
                    <td><?php echo $lang['cual_es_el_valor_titulo']; ?></td>
