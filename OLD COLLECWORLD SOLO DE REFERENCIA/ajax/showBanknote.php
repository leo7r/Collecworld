<script>
		...
		$("#show-right").load(path+'ajax/showBanknote/information.php',{id:id,url:'<?php echo $_REQUEST['url']; ?>'});
...
<div id="show-pc">
	...
	$sql="select b.*, bv.name as value, bd.name as denomination from banknotes b, banknotes_value bv, banknotes_denomination bd where id_banknotes=".$id." AND b.id_banknotes_value = bv.id_banknotes_value AND b.id_banknotes_denomination = bd.id_banknotes_denomination";
								...
								<div id="show-control">
									...
									<div class="show-control-pack">
										...
										<div class="show-control-item <?php if ( strpos($list,'1') ) echo 'checked'; ?>" id="col_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,3,1,<?php echo $datos['id_banknotes']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/own<?php if ( strpos($list,'1') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'1') ) echo 'checked'; ?>"  title="<?php echo $lang['tengo_esta']; ?>" />
										...
										<div class="show-control-item <?php if ( strpos($list,'2') ) echo 'checked'; ?>" id="wish_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,3,2,<?php echo $datos['id_banknotes']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/seek<?php if ( strpos($list,'2') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'2') ) echo 'checked'; ?>"  title="<?php echo $lang['quiero_esta']; ?>" />
										...
										<div class="show-control-item <?php if ( strpos($list,'3') ) echo 'checked'; ?>" id="swap_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,3,3,<?php echo $datos['id_banknotes']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/exchange<?php if ( strpos($list,'3') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'3') ) echo 'checked'; ?>"  title="<?php echo $lang['cambio_esta']; ?>" />
									...
									<div class="show-control-pack">
										...
										<div class="show-control-item <?php if ( strpos($list,'5') ) echo 'checked'; ?>" id="sell_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,3,5,<?php echo $datos['id_banknotes']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/sell<?php if ( strpos($list,'5') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'5') ) echo 'checked'; ?>" title="<?php echo $lang['vendo_esta']; ?>" />
										...
										<div class="show-control-item <?php if ( strpos($list,'4') ) echo 'checked'; ?>" >
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="location.href='<?php echo $path; ?>index.php/trade/banknote/<?php echo $datos['id_banknotes']; ?>'"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/trade.png"  title="<?php echo $lang['comercio_esta']; ?>" />
