...
<br><br>
<span style="float:left" class="google-button google-button-red" onclick="save_note('<?php echo $container_id; ?>',1,<?php echo $item_id; ?>,1,<?php echo $type; ?>, 0)"><?php echo $lang['agregar_otra']; ?></span>
<span style="float:right" class="google-button google-button-blue" onclick="save_note('<?php echo $container_id; ?>',1,<?php echo $item_id; ?>,1,<?php echo $type; ?>, 1);"><?php echo $lang['listo']; ?></span>
