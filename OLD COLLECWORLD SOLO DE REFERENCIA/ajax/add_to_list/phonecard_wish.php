...
<br><br>
<span style="float:right" class="google-button google-button-blue" onclick="save_note('<?php echo $container_id; ?>',1,<?php echo $item_id; ?>,2,<?php echo $type; ?>, 1);"><?php echo $lang['listo']; ?></span>