...
$sql = 'UPDATE phonecards SET image = "'.$img0.'" , image_reverse = "'.$img1.'" , vertical_anverse = '.($img0_vertical ? '1':'0').' , vertical_reverse = '.($img1_vertical ? '1':'0').'  WHERE id_phonecards = '.$_REQUEST['idPh'];
$res = mysql_query($sql);
echo 'OK';
