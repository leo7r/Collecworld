...
function showVariations( dom ){
	...
	if ( dom.checked ){
		phonecards_collections_select( id_users , list , id_countries , id_companies , system , catalog , 1 );
	}
	else{
...
function showMinus(){
	...
	system = $("#system").val();
	catalog = $("#catalog").val();
	no_variations = $("#no_variations").val();
	
	$("#collections_content").load(path+'ajax/account/collections/c_phonecards_list_minus.php',
...
if ( mysql_num_rows($cursor) > 0 ){
    ...
    <table cellpadding="10">
    	<tr>
        	<td>
            	<a href="<?php echo $path; ?>index.php/export/pdf/<?php echo $_SESSION['id_users']; ?>/<?php echo $list; ?>/<?php echo $id_countries; ?>/<?php echo $id_companies; ?>/<?php echo $catalog; ?>/<?php echo $system; ?>/<?php echo $no_variations; ?>/0" title="<?php echo $lang['exportar_pdf']; ?>"><img src="<?php echo $path; ?>img/pdf-icon.png" /></a>
            </td>
            <td>
            	<a href="<?php echo $path; ?>index.php/export/excel/<?php echo $_SESSION['id_users']; ?>/<?php echo $list; ?>/<?php echo $id_countries; ?>/<?php echo $id_companies; ?>/<?php echo $catalog; ?>/<?php echo $system; ?>/<?php echo $no_variations; ?>/0" title="<?php echo $lang['exportar_excel']; ?>"><img src="<?php echo $path; ?>img/excel-icon.png" /></a>
            </td>
            <td>
            ...
            <?php if($list==1){ ?>
            <td>
                <input type="button" onClick="showMinus()" value="<?php echo $lang['faltantes_coleccion']; ?>" class="google-button">
            </td>
            <?php } ?>
        </tr>
    </table>
	...
	?>
		<tr <?php echo $i % 2 != 0 ? 'class="odd"':''; ?> >
			...
			<td onClick="modalNote( <?php echo $datos_list['id_phonecards_users']; ?> , <?php echo $datos['id']; ?> , <?php echo $list; ?> , <?php echo $id_countries; ?> , <?php echo $catalog; ?> , <?php echo $id_companies; ?> )" title="<?php echo $lang['has_clic_para_editar_nota']; ?>" >
