...
<div>
	<ul id="show-tabs">
		<li class="box1" onClick="showBanknotesTab(0,<?php echo $id; ?>);"><?php echo $lang['informacion']; ?></li>
		...
		<li class="box1 selected" onClick="showBanknotesTab(3,<?php echo $id; ?>);"><?php echo $lang['comentarios']; ?></li>
	</ul>
</div>
<div id="comment-list">
	...
	if ( !$num ){
		?>
			<span class="title3"><?php echo $lang['sin_comentarios_moneda']; ?>.</span>
		<?php
	}
	?>
</div>	
