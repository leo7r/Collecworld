...
<?php echo $lang['comentario']; ?>
	...
	<div id="show-feedback-info">
		<?php echo $lang['no_aprece_sistema_chip_reportar']; ?>. <?php echo $lang['nota_recomendamos_cargar_foto']; ?>.
        <br>
	</div>
	<div id="feedback-content">
		<form id="feedback-form" action="<?php echo $path; ?>index.php/sendFeedback" method="post" enctype="multipart/form-data" >
            ...
            <input type="hidden" name="about" value="New system type" />
        	<table>
            	<tr>
                ...
                <tr>
                	<td><?php echo $lang['que_tipo_de_sistema_tienes']; ?>?</td>
                </tr>
                <tr>
                	<td>
