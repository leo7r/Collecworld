<script>
	...
	$(document).ready(function(){
		...
		$("#show-right").load(path+'ajax/showPhonecard/information.php',{id:id,url:'<?php echo $_REQUEST['url']; ?>'});
				...
				<td valign="top">
					...
					<div id='show-left'>
						...
						<div id="show-img">
							...
							<img id="show-image" onclick="flipImage(this);" src="<?php echo $datos['image'] ? $path.'upload/img/'.$datos['image'] : $path.'img/default_phonecard.jpg'; ?>" height="<?php if ( intval($datos['vertical_anverse']) == 1 ) echo '305'; else echo '194'; ?>" width="<?php if ( intval($datos['vertical_anverse']) == 1 ) echo '194'; else echo '305'; ?>" data-zoom-image="<?php echo $datos['image'] ? $path.'upload/img/'.$datos['image'] : $path.'img/default_phonecard.jpg'; ?>" />

							<img style="display:none;" id="show-image-rev" onclick="flipImage(this);" src="<?php echo $datos['image_reverse'] ? $path.'upload/img/'.$datos['image_reverse'] : $path.'img/default_phonecard.jpg'; ?>" height="<?php if ( intval($datos['vertical_reverse']) == 1 ) echo '305'; else echo '194'; ?>" width="<?php if ( intval($datos['vertical_reverse']) == 1 ) echo '194'; else echo '305'; ?>" data-zoom-image="<?php echo $datos['image_reverse'] ? $path.'upload/img/'.$datos['image_reverse'] : $path.'img/default_phonecard.jpg'; ?>" />
							...
							<form style="display:none;" id="new-image-form" action="<?php echo $path; ?>index.php/edit/phonecard/new_image" method="post" enctype="multipart/form-data">
								...
								<input type="hidden" id="id-pc" name="id-pc" value="<?php echo $datos['id_phonecards']; ?>" />
						...
						<div id="pc-info">
								...
								<div id="show-control">
									...
									<div class="show-control-pack">
										...
										<div class="show-control-item <?php if ( strpos($list,'1') ) echo 'checked'; ?>" id="col_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,1,1,<?php echo $datos['id_phonecards']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/own<?php if ( strpos($list,'1') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'1') ) echo 'checked'; ?>"  title="<?php echo $lang['tengo_esta']; ?>" />
										...
										<div class="show-control-item <?php if ( strpos($list,'2') ) echo 'checked'; ?>" id="wish_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,1,2,<?php echo $datos['id_phonecards']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/seek<?php if ( strpos($list,'2') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'2') ) echo 'checked'; ?>"  title="<?php echo $lang['quiero_esta']; ?>" />
										...
										<div class="show-control-item <?php if ( strpos($list,'3') ) echo 'checked'; ?>" id="swap_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,1,3,<?php echo $datos['id_phonecards']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/exchange<?php if ( strpos($list,'3') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'3') ) echo 'checked'; ?>"  title="<?php echo $lang['cambio_esta']; ?>" />
									...
									<div class="show-control-pack">
										...
										<div class="show-control-item <?php if ( strpos($list,'5') ) echo 'checked'; ?>" id="sell_cont">
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="setItemInList(this,1,5,<?php echo $datos['id_phonecards']; ?>,1);"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/sell<?php if ( strpos($list,'5') ) echo '2'; ?>.png" class="<?php if ( strpos($list,'5') ) echo 'checked'; ?>" title="<?php echo $lang['vendo_esta']; ?>" />
										...
										<div class="show-control-item <?php if ( strpos($list,'4') ) echo 'checked'; ?>" >
											...
											<img <?php if ( $_SESSION['id_users'] ){ ?>onclick="location.href='<?php echo $path; ?>index.php/trade/phonecard/<?php echo $datos['id_phonecards']; ?>'"<?php }else{ ?>onclick="location.href='<?php echo $path; ?>index.php/login'"<?php } ?> src="<?php echo $path; ?>img/trade.png"  title="<?php echo $lang['comercio_esta']; ?>" />
										...
										<div class="show-control-item" id="other-list-box">
											...
											<div id="other-list-icon">
												...
												<img src="<?php echo $path; ?>img/book.png"  <?php if ( $_SESSION['id_users'] ){ ?>onclick="showOtherList(this,1,<?php echo $datos['id_phonecards']; ?>);"<?php }else{ ?>onclick="showGlobalInfo('Must be logged');"<?php } ?>  />
							...
							<div id="show-social">
								...
								<?php
									...
									$uri = $datos['id_phonecards'].'-'.str_replace(" ","-",$datos['name']);

								?> 
								<input type="hidden" id="share-url" value="www.collecworld.com/index.php/phonecard/<?php echo $uri; ?>" />

								<input type="hidden" id="pc-name" value="<?php echo $datos['name']; ?>" />
