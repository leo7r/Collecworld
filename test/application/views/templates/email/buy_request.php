...
<title><?php echo $name.' '.$request_buy; ?></title>
                    	...
                    	<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                            	<td class="content_row featured_image" align="left" style="width: 580px; color:#fff;">
									<h1><?php echo $name.' '.$request_buy; ?></h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                                            	...
                                            	<table cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td bgcolor="#3396d8" height="30" width="110" align="center" class="button" style="font-family: 'Raleway', font-size: 12px; color: #ffffff; font-size: 13px; text-align: center; font-weight: normal; border-radius: 3px;">
															<a class="nodecoration" href="http://collecworld.com/index.php/trade/trade_details/<?php echo $trade_id; ?>" style="text-decoration: none; display: block; color: #ffffff; line-height: 30px;">
																<?php echo $view_more; ?>
															</a>
														</td>
                                                    </tr>
