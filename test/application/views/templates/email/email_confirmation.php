            	...
            	<tr>
                    ...
                    <td class="content" style="width: 580px;">
                    	<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                            	<td class="content_row featured_image" align="center" style="width: 580px;">
									<!-- <a class="nodecoration" href="#" style="text-decoration: none;">
                                    	<img src="#" width="363" height="240" style="display: block;" border="0" alt=""  />
                                    </a> -->
                                </td>
                            </tr>
                        </table>
                    	...
                    	<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                            	<td class="content_row" style="width: 580px;">
                                	...
                                	<p class="blog_title" style="font-family: 'Raleway'; font-size: 18px; color: #3498db; margin: 0; line-height: 18px;">
                            ...
                            <tr>
                        	   ...
                        	   <tr>
                            	<td class="content_row" style="width: 580px;">
                                	<table cellspacing="0" cellpadding="0" border="0">
                                    	<tr>
                                            <td class="blog_description" valign="top" align="left" style="width: 385px;">
                                            	<table cellspacing="0" cellpadding="0" border="0">
                                                	<tr>
                                                    	<td valign="top">
                                                        	<p class="blog_title" style="font-family: 'Raleway'; font-size: 18px; color: #3498db; margin: 0; line-height: 18px;">
                                                            	1. <?php echo $confirm_email; ?>
                                                            </p>
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<?php echo $just_have; ?>
                                                            </p>
                                                    ...
                                                    <tr>
                                                    	<td align="left" class="center_mob_button">
                                                        	<table cellspacing="0" cellpadding="0" border="0">
                                                                <tr>
                                                                    <td bgcolor="#3396d8" height="30" width="110" align="center" class="button" style="font-family: 'Raleway', font-size: 12px; color: #ffffff; font-size: 13px; text-align: center; font-weight: normal; border-radius: 3px;">
                                                                        <a class="nodecoration" href="http://collecworld.com/index.php/activate_user/<?php echo $info_user['id_users']; ?>/<?php echo $info_user['user']; ?>/1" style="text-decoration: none; display: block; color: #ffffff; line-height: 30px;">
                                                                            <?php echo $confirm; ?>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                            	...
                                            	<table cellspacing="0" cellpadding="0" border="0">
                                                	<tr>
                                                    	<td valign="top">
                                                            ...
                                                            <p class="blog_excerpt" style="font-family: 'Raleway'; font-size: 14px; color: #394041; margin: 10px 0; line-height: 18px;">
                                                            	<?php echo $click_one; ?>.<br /><?php echo $an_idea; ?>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
                    	...
                    	<table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                            	<td class="content_row" style="width: 580px;">
                                	<table cellspacing="0" cellpadding="0" border="0">
                                    	<tr>
                                        	<td class="one_third" style="width: 175px;" align="left" valign="top">
                                            	<table cellspacing="0" cellpadding="0" border="0">
                                                	<tr>
                                                    	<td>
                                                        	<a href="http://collecworld.com/index.php/activate_user/<?php echo $info_user['id_users']; ?>/<?php echo $info_user['user']; ?>/2" style="text-decoration: none;" class="nodecoration">
                                                        		<img src="http://www.collecworld.com/img/phonecards.jpg" width="175" height="116" style="display: block; border-radius: 6px;" border="0" alt=""  />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <!--<td class="one_third_spacer" style="width: 27px;">
                                            </td>
                                            <td class="one_third" style="width: 175px;" align="left" valign="top">
                                            	<table cellspacing="0" cellpadding="0" border="0">
                                                	<tr>
                                                    	<td>
                                                        	<a href="#" style="text-decoration: none;" class="nodecoration">
                                                        		<img src="http://labs.am-themes.com/Flattr/imgs/img4.png" width="175" height="116" style="display: block; border-radius: 6px;" border="0" alt=""  />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <td class="one_third_spacer" style="width: 28px;">
                                            </td>
                                            <td class="one_third" style="width: 175px;" align="left" valign="top">
                                            	<table cellspacing="0" cellpadding="0" border="0">
                                                	<tr>
                                                    ...
                                                    <tr>
                                                    	<td align="left" class="center_mob_button">
                                                        	<table cellspacing="0" cellpadding="0" border="0">
                                                                <tr>
                                                                    <td bgcolor="#3396d8" height="30" width="110" align="center" class="button" style="font-family: 'Raleway', font-size: 12px; color: #ffffff; font-size: 13px; text-align: center; font-weight: normal; border-radius: 3px;">
                                                                        <a class="nodecoration" href="http://collecworld.com/index.php/activate_user/<?php echo $info_user['id_users']; ?>/<?php echo $info_user['user']; ?>/3" style="text-decoration: none; display: block; color: #ffffff; line-height: 30px;">
                                                                            <?php echo $upload; ?>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                    	...
                    	<table cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                            	<td class="content_row" style="width: 580px; color: #394041; font-size: 12px; text-align: center; font-family: 'Raleway';">
                                   ...
                                   <br/>
<?php echo $send_by; ?> <a href="#" style="text-decoration: none; color: #394041;"><?php echo $email; ?></a>
                                </td>
                            </tr>
                            <tr>
                            	<td class="content_row" style="width: 580px;" height="20">
