...
<div id="content">
		...
		<div class="in">
			<div id="toolbar-left">
				<div class="item location">
					&nbsp;<a href="<?php echo base_url(); ?>index.php/init"><?php echo $this->lang->line('inicio'); ?></a>&nbsp;&raquo;&nbsp;<a href=""><?php echo $_SESSION['user']; ?></a>&nbsp;&raquo;
				</div>
			</div>
	...
	<input type="hidden" id="share-url" value="www.collecworld.com/index.php/<?php echo $_SESSION['user']; ?>" />
	<?php
	...
	<div id="content-in">
		...
		<div id="account-content">
			<div id="account-content-left">
				...
				<div id="account-edit"><span class="google-button" onClick="accountMenu(9);"><?php echo $this->lang->line('profile_editar_perfil'); ?></span></div>
				<br />
				<ul id="share-list">
				...
				<div class="account-menu-item menu-item-active"  onclick="accountMenu(0);"><?php echo $this->lang->line('vision_general'); ?></div>
				<div class="account-menu-item" onClick="accountMenu(1);"><?php echo $this->lang->line('mis_colecciones'); ?></div>
				<div class="account-menu-item" onClick="accountMenu(2);"><?php echo $this->lang->line('amigos'); ?></div>
				<div class="account-menu-item" onClick="accountMenu(3);"><?php echo $this->lang->line('eventos'); ?></div>
				<div class="account-menu-item" onClick="accountMenu(4);"><?php echo $this->lang->line('comercios'); ?></div>
				<div class="account-menu-item" onClick="accountMenu(5);"><?php echo $this->lang->line('mensajes'); ?> (<?php echo $not_readed; ?>)</div>
				<div class="account-menu-item" onClick="accountMenu(6);"><?php echo $this->lang->line('notificaciones'); ?></div>
				<div class="account-menu-item" onClick="accountMenu(7);"><?php echo $this->lang->line('configuracion'); ?></div>
				<div class="account-menu-item" onClick="javascript:location.href='<?php echo base_url(); ?>index.php/help'"><?php echo $this->lang->line('ayuda'); ?></div>
				<div class="account-menu-item" onClick="javascript:location.href='<?php echo base_url(); ?>index.php/out'"><?php echo $this->lang->line('cerrar_sesion'); ?></div>
			</div>
