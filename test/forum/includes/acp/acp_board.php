			...
			case 'settings':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'inherit_lang'			=> array('lang' => 'INHERIT_LANG',			'validate' => 'int',	'type' => 'custom', 'method' => 'select_inherit_lang', 'explain' => true),
						...
						'lang_click_enable'		=> array('lang' => 'LANG_CLICK_ENABLE',		'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
