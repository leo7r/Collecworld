...
/** 
*
* acp_styles.php [Argentinian Spanish]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	'ACP_IMAGESETS_EXPLAIN'	=> 'Los paquetes de imágenes incluyen todas las imágenes de botones, foros, carpetas, etc. y otras no específicas empleadas en el Sitio. Acá podes editar, exportar o borrar paquetes existentes y activar o importar nuevos.',
	'ACP_STYLES_EXPLAIN'	=> 'Acá podes administrar los estilos disponibles en su Sitio. Un estilo consiste de una plantilla (template), tema y paquete de imágenes. Podes alterar estilos existentes, borrar, desactivar, reactivar, crear o importar nuevos. También podes ver como se vería un estilo usando la función Vista Previa. El estilo por defecto actual es señalado con un asterisco (*). También se muestra el total de usuarios por cada estilo, tené en cuenta que sustituir los estilos de usuario no se reflejará aquí.',
	'ACP_TEMPLATES_EXPLAIN'	=> 'Un paquete de plantillas incluye todas las páginas usadas para generar la apariencia de su Sitio. Acá podes editar, borrar, exportar e importar, y hacer una vista previa de las plantillas. También podes modificar el código empleado para generar BBCodes.',
	'ACP_THEMES_EXPLAIN'	=> 'Desde acá podes crear, instalar, editar, borrar y exportar temas. Un tema es la combinación de colores e imágenes que se aplica a las plantillas para definir el aspecto general de su Sitio. El rango de opciones disponible depende de la configuración de su servidor y la instalación de phpBB, leé el manual para más detalles. Por favor observa que cuando creas nuevos temas podes usar uno existente como base.',
	'ADD_IMAGESET'			=> 'Crear paquete de imágenes',
	'ADD_IMAGESET_EXPLAIN'	=> 'Acá podes crear un nuevo paquete de imágenes. Dependiendo de la configuración del servidor y los permisos de archivo tendrás opciones adicionales. Por ejemplo podrías basar este paquete de imágenes en otro ya existente. También subir o importar (de la carpeta store) un paquete de imágenes. Si subís o importas un archivo, el nombre del paquete podría tomar por defecto el nombre del archivo (para hacer esto deja el nombre del paquete en blanco).',
	'ADD_STYLE'				=> 'Crear estilo',
	'ADD_STYLE_EXPLAIN'		=> 'Acá podes crear un nuevo estilo. Dependiendo de la configuración del servidor y los permisos de archivo tendrán opciones adicionales. Por ejemplo podrías basar este estilo en otro ya existente. También subir o importar (de la carpeta store) un estilo. Si subís o importas un archivo, el nombre del estilo podría tomar por defecto el nombre del archivo (para hacer esto deja el nombre del estilo en blanco).',
	'ADD_TEMPLATE'			=> 'Crear una plantilla',
	'ADD_TEMPLATE_EXPLAIN'	=> 'Acá podes crear una nueva plantilla. Dependiendo de la configuración del servidor y los permisos de archivo tendrán opciones adicionales. Por ejemplo podrías basar esta plantilla en otra ya existente. También subir o importar (de la carpeta store) una plantilla. Si subís o importas un archivo, el nombre de la plantilla podría tomar por defecto el nombre del archivo (para hacer esto dejá el nombre de la plantilla en blanco).',
	'ADD_THEME'				=> 'Crear tema',
	'ADD_THEME_EXPLAIN'		=> 'Acá podes crear un nuevo tema. Dependiendo de la configuración del servidor y los permisos de archivo tendrán opciones adicionales. Por ejemplo podrías basar este tema en otro ya existente. También subir o importar (de la carpeta store) un tema. Si sube o importa un archivo, el nombre del tema podría tomar por defecto el nombre del archivo (para hacer esto deja el nombre del tema en blanco).',
	...
	'CONFIRM_IMAGESET_REFRESH'		=> '¿Estás seguro de que querés actualizar los datos? Los configuración de configuración sobrescribirán todas las modificaciones que hayas hecho con el editor.',
	'CONFIRM_TEMPLATE_CLEAR_CACHE'	=> '¿Estás seguro de que querés limpiar todas las versiones cacheadas de sus plantillas?',
	'CONFIRM_TEMPLATE_REFRESH'		=> '¿Estás seguro de que querés sobrescribir las plantillas en la base de datos con el contenido de los archivos? Esto sobrescribirá todas las modificaciones que hayas hecho con el editor de plantillas.',
	'CONFIRM_THEME_REFRESH'			=> '¿Estás seguro de que querés sobrescribir el tema en la base de datos con el contenido de los archivos? Esto sobrescribirá todas las modificaciones que hayas hecho con el editor de temas.',
	'COPYRIGHT'						=> 'Copyright',
	...
	'DEACTIVATE_DEFAULT'			=> 'No podes desactivar el estilo por defecto.',
	'DELETE_FROM_FS'				=> 'Borrar del sistema',
	'DELETE_IMAGESET'				=> 'Borrar paquete de imágenes',
	'DELETE_IMAGESET_EXPLAIN'		=> 'Acá podes eliminar el paquete de imágenes seleccionado de la base de datos. Por favor tené en cuenta que esa acción no se puede deshacer. Es recomendable que primero lo exportes para usarlo en el futuro.',
	'DELETE_STYLE'					=> 'Borrar estilo',
	'DELETE_STYLE_EXPLAIN'			=> 'Acá podes eliminar el estilo seleccionado. Tené en cuenta que esa acción no se puede deshacer.',
	'DELETE_TEMPLATE'				=> 'Borrar plantilla',
	'DELETE_TEMPLATE_EXPLAIN'		=> 'Acá podes eliminar la plantilla seleccionada de la base de datos. Por favor tené en cuenta que esa acción no se puede deshacer. Es recomendable que primero lo exportes para usarlo en el futuro.',
	'DELETE_THEME'					=> 'Borrar tema',
	'DELETE_THEME_EXPLAIN'			=> 'Acá podes eliminar el tema seleccionado de la base de datos. Por favor tené en cuenta que esa acción no se puede deshacer. Es recomendable que primero lo exportes para usarlo en el futuro.',
	'DETAILS'						=> 'Detalles',
	...
	'EDIT_DETAILS_IMAGESET_EXPLAIN'	=> 'Acá podes editar ciertos detalles del paquete como por ejemplo su nombre.',
	'EDIT_DETAILS_STYLE'			=> 'Editar plantilla',
	'EDIT_DETAILS_STYLE_EXPLAIN'	=> 'Usando el siguiente formulario podés modificar esta plantilla. Podés cambiar la combinación de plantilla, tema y paquete de imágenes lo cual define un estilo en si mismo. Podes hacerlo también estilo por defecto.',
	'EDIT_DETAILS_TEMPLATE'			=> 'Editar detalles de plantilla',
	'EDIT_DETAILS_TEMPLATE_EXPLAIN'	=> 'Acá podes editar ciertos detalles de la plantilla como por ejemplo su nombre. También tiene la opción de elegir entre almacenar en el sistema a la base de datos y viceversa. Esta opción depende de la configuración de PHP y si tenés los permisos adecuados en el servidor.',
	'EDIT_DETAILS_THEME'			=> 'Editar detalles de plantilla',
	'EDIT_DETAILS_THEME_EXPLAIN'	=> 'Acá podes editar ciertos detalles del tema como por ejemplo su nombre. También tiene la opción de alternar entre almacenar en el sistema a la base de datos y viceversa. Esta opción depende de la configuración de PHP y si tenés los permisos adecuados en el servidor.',
	'EDIT_IMAGESET'					=> 'Editar paquete de imágenes',
	'EDIT_IMAGESET_EXPLAIN'			=> 'Acá podes editar las imágenes individuales que incluye el paquete. También podés especificar las dimensiones de la imagen. Las dimensiones son opcionales, especificarlas puede acarrear dificultades de visualización con algunos navegadores. No especificarla reduce un poco el tamaño del registro en la base de datos.',
	'EDIT_TEMPLATE'					=> 'Editar plantilla',
	'EDIT_TEMPLATE_EXPLAIN'			=> 'Acá podes editar su plantilla directamente. Por favor recordá que esas ediciones son permanentes y no se pueden deshacer una vez enviadas. Si PHP puede escribir en su carpeta de estilos cualquier cambio, acá se guardará directamente en el sistema. Si PHP no puede escribir, serán copiados en la base de datos y los cambios se reflejarán solo allí. Por favor está atento cuando edites tus plantillas y recordá cerrar todos los reemplazos de variables {XXXX} e instrucciones condicionales (IF/ENDIF).',
	...
	'EDIT_THEME_EXPLAIN'			=> 'Acá podes editar la plantilla seleccionada, cambiar colores, imágenes, etc.',
	...
	'FONT_FACE_EXPLAIN'		=> 'Podes especificar múltiples fuentes separadas por comas. Si un usuario no tiene la primera fuente instalada, se usará la siguiente.',
	...
	'IMAGESET_ERR_ARCHIVE'		=> 'Por favor selecciona un método.',
	...
	'IMAGESET_EXPORT_EXPLAIN'	=> 'Acá podes exportar un paquete de imágenes a un archivo. Este archivo contendrá todos los datos necesarios para instalar las imágenes en otro Sitio. Podes seleccionar descargarlo directamente o ponerlo en la carpeta store para bajarlo después o vía FTP.',
	...
	'IMG_TOPIC_UNREAD_LOCKED'		=> 'Tema bloqueado con mensajes sin leer',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Tema bloqueado con mensajes sin leer (mío)',
	...
	'INSTALL_IMAGESET_EXPLAIN'	=> 'Acá podes instalar tu paquete de imágenes seleccionado. Podés editar ciertos detalles si querés, o usar la instalación por defecto.',
	'INSTALL_STYLE'				=> 'Instalar estilo',
	'INSTALL_STYLE_EXPLAIN'		=> 'Acá podes instalar un nuevo estilo y si es apropiado, sus distintos elementos. Si ya los tenés instalados, no se sobrescribirán. Algunos estilos requieren ciertos elementos para ser instalados. Si tratas de instalar un estilo y no tenés los elementos requeridos, serán notificado.',
	'INSTALL_TEMPLATE'			=> 'Instalar plantilla',
	'INSTALL_TEMPLATE_EXPLAIN'	=> 'Acá podes instalar un nuevo juego de plantillas. Tendrás ciertas opciones según la configuración de su servidor.',
	'INSTALL_THEME'				=> 'Instalar tema',
	'INSTALL_THEME_EXPLAIN'		=> 'Acá podes instalar el tema seleccionado. Podés editar ciertos detalles si querés, o usar la instalación por defecto.',
	...
	'ONLY_STYLE'				=> 'Éste es el último estilo, no podes borrarlo.',
	...
	'STYLE_ERR_ARCHIVE'			=> 'Por favor selecciona un método.',
	...
	'TEMPLATE_CACHE_EXPLAIN'	=> 'Por defecto phpBB cachea versiones precompiladas de las plantillas. Esto disminuye la carga del servidor cada vez que se visita una pagina y por lo tanto el tiempo de generación de esa página. Acá podes ver el estado de cada archivo y borrarlos individualmente o el caché completo.',
	...
	'TEMPLATE_EDITOR'			=> 'Editor de código HTML',
	...
	'TEMPLATE_EXPORT_EXPLAIN'	=> 'Acá podes exportar un juego de plantillas en forma de archivo. Contendrá todos los archivos necesarios para instalar el juego de plantillas en otro Sitio. Tenés que seleccionar si descargas el archivo directamente o ponerlo en la carpeta store para descargarlo más tarde o vía FTP.',
	...
	'THEME_ERR_ARCHIVE'			=> 'Por favor selecciona un método.',
	...
	'THEME_EXPORT_EXPLAIN'		=> 'Acá podes exportar una plantilla en forma de archivo. Contendrá todos los archivos necesarios para instalar el juego de plantillas en otro Sitio. Tenés que seleccionar si descargas el archivo directamente o ponerlo en la carpeta store para descargarlo más tarde o vía FTP.',
