...
/** 
*
* help_bbcode [Argentinian Spanish]
*
* @package language
...
$help = array(
	...
	array(
		...
		1 => 'BBCode soporta dos tipos de listas: ordenas y desordenadas. Son esencialmente iguales a las listas HTML. Una lista desordenada muestra cada ítem uno después del otro identificado con una viñeta. Para crear una lista desordenada debes utilizar <strong>[list][/list]</strong> definiendo cada item usando <strong>[*]</strong>. Por ejemplo, para armar una lista de sus colores favoritos debes escribir:<br /><br /><strong>[list]</strong><br /><strong>[*]</strong>Rojo<br /><strong>[*]</strong>Azul<br /><strong>[*]</strong>Amarillo<br /><strong>[/list]</strong><br /><br />Se generará la siguiente lista:<ul><li>Rojo</li><li>Azul</li><li>Amarillo</li></ul>'
	),
	array(
	...
	array(
		...
		1 => 'Si perteneces a La Administración de este foro y posees los permisos apropiados, podes agregar nuevos BBCodes desde el Panel del Administrador.'
	)
);
