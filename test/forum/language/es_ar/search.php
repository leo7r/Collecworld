...
/** 
*
* search.php [Argentinian Spanish]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'NO_SEARCH_TIME'	=> 'Disculpa, no podes buscar en este momento. Por favor, intentá nuevamente en unos minutos.',
	...
	'SEARCH_FORUMS_EXPLAIN'		=> 'Selecciona el Foro o Foros en los que deseas buscar. Para agilizar podes buscar en los subforos seleccionando el Foro padre y habilitar la búsqueda en los subforos (en Opciones de búsqueda).',
	'SEARCH_IN_RESULTS'			=> 'Buscar en los resultados',
	'SEARCH_KEYWORDS_EXPLAIN'	=> 'Escribí <strong>+</strong> delante de una palabra a encontrar y <strong>-</strong> delante de la palabra para excluirla. Crea una lista de palabras separadas por <strong>|</strong> entre corchetes si solo una de ellas se quiere encontrar. Emplea <strong>*</strong> como comodín para coincidencias parciales.',
