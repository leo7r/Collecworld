...
var path = 'http://test.collecworld.com/';
var menu0;
...
function showInfo3(dom , num , id , float){
	...
	$(out_div).load(path+'ajax/info_chip_logo.php',{num:num,id:id,src:dom.src},function(){
	...
	if ( num == 0 || num == 2 ){
		right.innerHTML = 'Info about this system type will be available soon.';
	}
	else{
		right.innerHTML = 'Info about this logo will be available soon.';
	}
	...
	//$(out_div).css({ left: x+50 , top: y+50 });
...
function showInfo2( dom , info , num ){
	...
	//$(pointer).addClass('new-info-pointer2');
...
function hideInfo(){
	...
	$('.infoo').fadeOut(500,function(){ $(this).remove(); });
